-- Create places table for Victoria Falls experiences
CREATE TABLE IF NOT EXISTS places (
  ...
  label VARCHAR(50) NOT NULL CHECK (label IN ('popular', 'hidden gem', 'local favorite')),
...
CREATE INDEX IF NOT EXISTS idx_places_label ON places (label);

-- Insert initial Victoria Falls data
